...
function update() {
    ...
    if (topCollision(ball, player)) {
      ...
      // Ajustamos la velocidad X de la pelota según la posición en la que golpea la barra
      ball.velocityX = (ball.x - (player.x + player.width / 2)) / (player.width / 2) * 5 + (Math.random() - 0.5) * 2;
